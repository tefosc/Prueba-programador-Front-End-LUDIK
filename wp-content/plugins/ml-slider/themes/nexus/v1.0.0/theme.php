    ...
    public function theme_customize( $css, $settings, $slideshow_id )
    {
        ...
        if ( isset( $settings['theme_customize'] ) ) {
            ...
            if ( isset( $customize['navigation_color'] ) ) {
                $new_css .= "
                #metaslider-id-{$slideshow_id} .flexslider .flex-control-paging li a{
                    background-color: " . esc_html( $customize['navigation_color'] ) . "; 
                }";
            }

            if ( isset( $customize['navigation_color_hover'] ) ) {
                $new_css .= "
                #metaslider-id-{$slideshow_id} .flexslider .flex-control-paging li a:hover {
                    background-color: " . esc_html( $customize['navigation_color_hover'] ) . "; 
                }";
            }
            ...
            if ( isset( $customize['navigation_color_active'] ) ) {
                ...
                #metaslider-id-{$slideshow_id} .flexslider .flex-control-nav li a.flex-active {
                    background-color: " . esc_html( $customize['navigation_color_active'] ) . "; 
                }";
            }
           ...
           if ( isset( $customize['caption_background'] ) ) {
                ...
                #metaslider-id-{$slideshow_id} .flexslider .caption-wrap {
                    background-color: " . esc_html( $customize['caption_background'] ) . "; 
                }";
           }
